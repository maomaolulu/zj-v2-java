...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/project/testLink", "anon");//测试访问路径
...
//        filterMap.put("/anlian/tokenExpire/updateTokenTime/{isUpDate}", "anon");//重新给token失效时间赋值

        filterMap.put("/ping", "anon");//测试数据库连接

        filterMap.put("/postPfn/deleteTable", "anon");
        //
