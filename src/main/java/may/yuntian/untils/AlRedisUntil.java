...
//        retMap = alRedisUntil.jsonToMap((String)alRedisUntil.get("token_123"));
//        System.out.println(retMap);
//		System.out.println(retMap.get("user_info"));
//    	String nString = WordUtils.capitalizeFully(alRedisUntil.toJson(retMap.get("user_info")), new char[]{'_'}).replace("_", "" );
//		System.out.println("..............."+nString);
//		SysUserEntity account = alRedisUntil.fromJson(nString,SysUserEntity.class);
